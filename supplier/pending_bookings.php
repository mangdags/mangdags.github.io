...
include("asset/include/config.php");
  ...
  if (isset($_POST['accept']))
  {
     ...
     if ($update_event) {
        echo "<script>
                alert('Supplies Confirmed!');
                window.location.href=pending_bookings.php
              </script>";
     }else
     {
        echo "<script>
                alert('Cannot update supplies for the meantime, Please try again!');
                window.location.href=pending_bookings.php
              </script>";
     }
...
<?php include('navigation.php') ?>
 ...
 <section style="padding: 5% 5% 0% 5% ">
        ...
        <h1 class="text-center pt-5" style="font-size: 4em;">PENDING SUPPLIES FOR BOOKING</h1>
