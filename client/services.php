      ...
      <div class="p-5 table-responsive rounded" style="background-color: rgba(255, 250, 240, 0.8);">
        <h3 class="text-center">Services</h3>
          ...
          <?php
            ...
            $query = "SELECT * FROM works WHERE account_id = '".$_GET['account_id']."'";
            $result = mysqli_query($connect, $query);
            $row2 = mysqli_fetch_array($result);
          ?>
           <div class="col-lg-12 mt-5">
             <div class="card bg-transparent border-0">
              <img src="../supplier/asset/images/<?php echo $row2['file_name'] ?>">
              ...
              <div class="col-lg-3 mt-5" style="height: 250px;">
                <img src="../supplier/asset/images/<?php echo $row3['file_name'] ?>" width="100%" height="250px">
              </div>
            <?php } ?>
          </div>
             </div>
